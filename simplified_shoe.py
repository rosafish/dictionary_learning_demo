...
import simplified_shoe_config as shoe_config
...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="+",
        choices=[e.value for e in shoe_config.TrainerType],
        required=True,
...
def run_sae_training(
    ...
    trainer_configs = shoe_config.get_trainer_configs(
        architectures,
        learning_rates,
        random_seeds,
        activation_dim,
    ...
    if not dry_run:
        ...
        trainSAE(
            ...
            save_dir=save_dir,
            log_steps=log_steps,
            wandb_project=shoe_config.wandb_project,
